...
### User story 1
Som patient vil jeg kunne oprette et nyt behandlingsforløb, så jeg kan begynde at følge min behandling fra start.

**Acceptkriterier:**
- Acceptkriterie 1: "Givet en patient er logget ind, når patienten vælger en forløbstype og opretter et forløb, så vises det nye forløb på patientens oversigt" → tester at selve oprettelsen virker og bliver synlig (en patient kan godt have flere forløb, fx et afsluttet og et nyt)
...
### User story 5
Som patient vil jeg kunne oprette en profil og logge ind, så jeg kan få adgang til mit eget, private forløb.
